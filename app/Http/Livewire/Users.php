    ...
    */
    ...
    public function datasource(): Builder
    {
        return User::query()
            ...
            ->select('users.*', 'departments.dept_name as dept');
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('email_address_lower', function (User $model) {
                return strtolower(e($model->email_address));
            })
